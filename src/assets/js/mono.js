...
$(document).ready(function() {
  ...
  /*======== Advance DROPDOWN NOTIFY ========*/
  var advanceToggle = $('.advance-toggle');
  var advanceDropdownNotify = $('.advance-dropdown-notify');

  if (advanceToggle.length !== 0){
    advanceToggle.on('click', function () {
      if (!advanceDropdownNotify.is(':visible')){
        advanceDropdownNotify.fadeIn(5);
      }else {
        advanceDropdownNotify.fadeOut(5);
      }
    });

    $(document).mouseup(function (e) {
      if (!advanceDropdownNotify.is(e.target) && advanceDropdownNotify.has(e.target).length === 0){
        advanceDropdownNotify.fadeOut(5);
      }
    });
  }
  ...
  /*======== 12. Custom Advance SEARCH ========*/
  $(".icon-close").click(function() {
    $('.inner-field').addClass("d-none");
  });

  /*======== Close Row ========*/
  $(".close-row").click(function() {
    $('.catagory-input').addClass("d-none");
  });
